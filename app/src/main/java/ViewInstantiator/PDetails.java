...
public class PDetails {
    ...
    public PDetails(String jsonSkuDetails) throws JSONException {
        this(ViewInstantiatorHelper.ITEM_TYPE_INAPP, jsonSkuDetails);
    }

    public PDetails(String itemType, String jsonSkuDetails) throws JSONException {
        mItemType = itemType;
