...
public class LockedLayout extends RelativeLayout{
    ...
    private void setView(int visibility){
        ViewHelper.setVisibility( visibility, this, upgradeBtn, lockedImg);
    }

    public void setOnUpgradeBtnClick(View.OnClickListener onUpgradeBtnClick){
        upgradeBtn.setOnClickListener(onUpgradeBtnClick);
    }

    public void setOnLockImgClick(View.OnClickListener onLockImgClick){
        lockedImg.setOnClickListener(       onLockImgClick   );
    }

    public void saveState(Bundle outstate){
        outstate.putBoolean("isVisible", lockedImg.getVisibility() == VISIBLE );
    };

    public void restoreState(Bundle savedInstance){
        int vis =  savedInstance.getBoolean("isVisible" , false) ? View.VISIBLE : View.GONE ;
        setView( vis );
    }
